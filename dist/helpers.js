...
const int64copy = (dst, src) => {
    dst.h = src.h;
    dst.l = src.l;
};
const int64rrot = (dst, x, shift) => {
    dst.l = (x.l >>> shift) | (x.h << (32 - shift));
    dst.h = (x.h >>> shift) | (x.l << (32 - shift));
};
const int64revrrot = (dst, x, shift) => {
    dst.l = (x.h >>> shift) | (x.l << (32 - shift));
    dst.h = (x.l >>> shift) | (x.h << (32 - shift));
};
const int64shr = (dst, x, shift) => {
    dst.l = (x.l >>> shift) | (x.h << (32 - shift));
    dst.h = (x.h >>> shift);
};
const int64add = (dst, x, y) => {
...
const sha512cryptIntermediate = (password, salt) => {
...
const rstrSha512crypt = (password, salt, rounds) => {
